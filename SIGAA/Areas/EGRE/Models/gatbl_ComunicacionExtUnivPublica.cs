...
{
    public class gatbl_ComunicacionExtUnivPublica:BaseModelo
    {

        public gatbl_ComunicacionExtUnivPublica()
        {
            sGestion_desc = "2016";
        ...
        [Key]
        public int iComExtUnivPublica_id { get; set; }
        ...
        public virtual gatbl_RectorUniversidadPublica RectorUniversidadPublica { get; set; }
    }
}
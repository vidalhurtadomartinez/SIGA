...
{
    public class tblFormularioPublicado
    {
        [Key]
        public int lFormularioPublicado_id { get; set; }
        ...
        [ForeignKey(name: "lFormularioHistorico_id")]
        public virtual tblFormularioHistorico tblFormularioHistorico { get; set; }

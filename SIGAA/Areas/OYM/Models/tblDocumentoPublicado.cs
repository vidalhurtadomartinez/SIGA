...
{
    public class tblDocumentoPublicado
    {
        [Key]
        public int lDocumentoPlublicado_id { get; set; }
        ...
        [Required(ErrorMessage = "Debe ingresar el campo {0}")]
        [Display(Name = "Documento Historico")]
        public int lDocumentoHistorico_id { get; set; }
        ...
        [ForeignKey(name: "lDocumentoHistorico_id")]
        public virtual tblDocumentoHistorico tblDocumentoHistorico { get; set; }

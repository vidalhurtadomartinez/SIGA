...
{
    partial class rptDocumentoDetalleRespuesta
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(rptDocumentoDetalleRespuesta));
            ...
            this.sqlDataSourceDocumento = new Telerik.Reporting.SqlDataSource();
    ...
    ") + \")\"";
            ...
            // 
            // sqlDataSourceDocumento
            // 
            this.sqlDataSourceDocumento.ConnectionString = "SeguimientoReports.Properties.Settings.DBSeguimiento";
            this.sqlDataSourceDocumento.Name = "sqlDataSourceDocumento";
            this.sqlDataSourceDocumento.SelectCommand = "Select * From tblDocumento";
            // 
            // pageHeaderSection1
            // 
            ...
            this.textBox19.Value = "DETALLE DE RESPUESTAS POR PROCESOS DE DOCUMENTOS";
            // 
            // detail
            // 
            ...
            this.sqlDataSourceLista.SelectCommand = "dbo.sp_DocumentoDetalleRespuestaPorProcesoReporte";
            ...
            this.Filters.Add(new Telerik.Reporting.Filter("= Fields.Id", Telerik.Reporting.FilterOperator.In, "= Parameters.Documento.Value"));
            ...
            group2.Groupings.Add(new Telerik.Reporting.Grouping("= Fields.lDocumentoProceso_id"));
            group2.Name = "group1";
            group2.Sortings.Add(new Telerik.Reporting.Sorting("= Fields.lDocumentoProceso_id", Telerik.Reporting.SortDirection.Asc));
            ...
            this.Name = "rptDocumentoDetalleRespuesta";
            ...
            reportParameter2.AvailableValues.DataSource = this.sqlDataSourceDocumento;
            ...
            reportParameter2.Name = "Documento";
            reportParameter2.Text = "Documento";
        ...
        private Telerik.Reporting.SqlDataSource sqlDataSourceDocumento;
    }
}